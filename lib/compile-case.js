...
function generateShell(suiteDir, data) {
  ...
  var code = [
    ...
    'function ', jsCaseName, '(ENVIRONMENT){',
      ...
      'ENVIRONMENT.tape.end=(function(tape_end){return function(){ENVIRONMENT.CONTEXT_LIST.forEach(function(gl) { (gl.destroy && gl.destroy()); }); ENVIRONMENT.CONTEXT_LIST = [];tape_end.call(ENVIRONMENT.tape);}})(ENVIRONMENT.tape.end);',
